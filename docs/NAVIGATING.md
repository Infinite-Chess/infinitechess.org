...
[← Back to Setup Guide](./SETUP.md) | [Contributing Guide](./GUIDELINES.md)
...
| [`src/server/`](../src/server/)                                     | Contains all server-side files. The server begins running from [`server.ts`](../src/server/server.ts). This configures and starts our http, https, and websocket servers, and cleans up on closing.                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| [`src/server/views/`](../src/server/views/)                         | Contains our Nunjucks (`.njk`) templates — the home of every page's markup, rendered by the server on request. Modify these to change the content on the website pages. In order to support multiple languages, these documents reference many of the translations in [`en-US.toml`](../translation/en-US.toml). Any changes to the toml file requires you increment the version number at the top of it, and record the change you made inside [`changes.json`](../translation/changes.json). Additional information on working other languages of the website is in [TRANSLATING.md](./TRANSLATING.md). |
| [`src/client/views/`](../src/client/views)                          | Contains our legacy EJS documents, which are converted to HTMLs on startup. Being gradually retired page by page during the website redesign as each is rewritten as a Nunjucks template above.                                                                                                                                                                                                                                                                                                                                                                                                           |
| [`src/client/scripts/esm/board/`](../src/client/scripts/esm/board/) | Contains the code for drawing a board, shared by every page that renders one at all, including pages that show variant preview tooltips.                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| [`src/client/scripts/esm/game/`](../src/client/scripts/esm/game/)   | Contains the code shared by every page with an interactive board. The frame loop is [`gameloop.ts`](../src/client/scripts/esm/game/gameloop.ts).                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| [`src/client/scripts/esm/views/`](../src/client/scripts/esm/views/) | Contains each page's own entry point and private code.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| [`src/server/game/`](../src/server/game/)                           | Contains the server-side code for running online play, including the seeks manager and game manager. Both of these use websocket messaging to broadcast changes out to the clients in real-time.                                                                                                                                                                                                                                                                                                                                                                                                          |
...
- `7`: Toggles engine move generation highlights. This indicates all the moves the engine will consider in the position. Only works for the Apeiron engine.
