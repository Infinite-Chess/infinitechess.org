...
* Faire glisser avec double clic droit pour dessiner des *rayons*, des lignes infinies de cases surlignées. Ils peuvent être utilisés pour prévoir des attaques à longue distance rapidement et efficacement, sans faire de calcul mental pour trouver la case sur laquelle se déplacer.
...
* Les mini-images, même lorsqu'elle sont désactivées dans les grandes variantes, affichent désormais systématiquement les pièces au-dessus des cases surlignées, ainsi que la dernière pièce déplacée. C'est utile pour suivre les pièces importantes en étant dézoomé dans les grandes variantes de showcase.
