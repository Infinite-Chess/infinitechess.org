// src/shared/chess/preview_variants/variants/prev_amazonchandelier.ts
...
export function gameruleModifications(): GameRuleModifications {
	return {
		promotionRanks: { [p.WHITE]: [10n], [p.BLACK]: [-9n] },
		promotionsAllowed: [...DEFAULT_PROMOTIONS, r.HAWK, r.GUARD, r.AMAZON],
	};
}
