// src/shared/chess/variants/variantdictionary.ts
...
const variantDictionary = buildVariantDictionary({
	...
	Pawndard: {
		name: 'Pawndard',
		positionString: {
			// To get a UTC timestamp in ms from a date and time: new Date('YYYY-MM-DDTHH:MM:SSZ').getTime()
			// March 27, 2026, 12:00AM UTC - Kings are no longer given special rights.
			1774569600000:
