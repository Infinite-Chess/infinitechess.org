// src/shared/chess/variants/variant_scripts/variants/var_standarch.ts
...
export function gameruleModifications(): GameRuleModifications {
	return {
		promotion: { pieces: [...gamerules.DEFAULT_PROMOTION_PIECES, r.CHANCELLOR, r.ARCHBISHOP] },
	};
}
...
export function getPositionBox(): BoundingBox {
	return { left: 0n, right: 9n, bottom: -2n, top: 11n };
}
