// src/shared/chess/variants/variant_scripts/variants/var_coaipho.ts
...
export function gameruleModifications(): GameRuleModifications {
	return {
		promotion: {
			pieces: [...DEFAULT_PROMOTION_PIECES, r.GUARD, r.CHANCELLOR, r.HAWK, r.HUYGEN],
		},
	};
}
...
export function getPositionBox(): BoundingBox {
	return { left: -4n, right: 13n, bottom: -5n, top: 14n };
}
