// src/shared/chess/variants/variant_scripts/variants/var_coaipro.ts

/**
 * "Chess on an Infinite Plane - Roses Option" standard variant.
 */
...
export function gameruleModifications(): GameRuleModifications {
	return {
		promotion: { pieces: [...DEFAULT_PROMOTION_PIECES, r.GUARD, r.CHANCELLOR, r.ROSE] },
	};
}
...
export function getPositionBox(): BoundingBox {
	return { left: -4n, right: 13n, bottom: -6n, top: 15n };
}
