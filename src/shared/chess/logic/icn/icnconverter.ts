...
const singleMetadataSource = String.raw`\[([a-zA-Z]+)\s+"([^"]{1,200})"\]`; // Max metadata value length of 100 chars for safety. This prevents, if we forget a closing ", the regex consuming the entirity of the ICN
