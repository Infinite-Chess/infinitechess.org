...
/** Widens a box of plain numbers into one of BigDecimals. */
...
/** Widens a box of bigints into one of BigDecimals. */
...
/** {@link expandBoxToContainSquare} but for BigDecimal boxes. DESTRUCTIVE. */
...
/** Returns the minimum bounding box that contains both of the provided boxes. */
...
/** {@link mergeBoundingBoxes} but for BigDecimal boxes. */
...
/** Translates a bounding box by the given coordinates. Non-mutating. */
...
/**
 * Whether `innerBox` is entirely contained within `outerBox`.
 * No overhang allowed, but edges can touch.
 */
...
/** {@link boxContainsBox} but for BigDecimal boxes. */
...
/** Whether two boxes have zero overlap. They are allowed to touch sides. */
...
/** Whether the provided box contains the square coordinate. */
...
/** Whether the provided BigDecimal box contains the square coordinate. */
...
/** Whether the provided plain-number box contains the square coordinate. */
