...
const defaultPromotions = [
    typeutil.intTypes.knights,
    typeutil.intTypes.bishops,
    typeutil.intTypes.rooks,
    typeutil.intTypes.queens
];
const defaultPromotionsAllowed = repeatPromotionsAllowedForEachColor(defaultPromotions);
const coaIPPromotions = [
    ...defaultPromotions,
    typeutil.intTypes.guards,
    typeutil.intTypes.chancellors,
    typeutil.intTypes.hawks
];
...
const variantDictionary = {
    ...
    Standarch: {
        ...
        gameruleModifications: { promotionsAllowed: repeatPromotionsAllowedForEachColor([...defaultPromotions,typeutil.intTypes.chancellors,typeutil.intTypes.archbishops]) }
    },
    Space_Classic: {
        positionString: {
        ...
        gameruleModifications: {
            ...
            0: { promotionRanks: [4,-3], promotionsAllowed: defaultPromotionsAllowed }
        }
    },
    CoaIP: {
    ...
    Pawn_Horde: {
        ...
        gameruleModifications: { winConditions: { white: ['checkmate'], black: ['allpiecescaptured'] }, promotionRanks: [2,-7], promotionsAllowed: defaultPromotionsAllowed }
    },
    Space: {
        ...
        gameruleModifications: { promotionRanks: [4,-3], promotionsAllowed: repeatPromotionsAllowedForEachColor([...defaultPromotions,typeutil.intTypes.hawks,typeutil.intTypes.centaurs,typeutil.intTypes.archbishops,typeutil.intTypes.chancellors]) }
    },
    Obstocean: {
    ...
    Abundance: {
        ...
        gameruleModifications: { promotionRanks: [6,-6], promotionsAllowed: repeatPromotionsAllowedForEachColor([...defaultPromotions, typeutil.intTypes.guards,typeutil.intTypes.hawks,typeutil.intTypes.chancellors]) }
    },
    Amazon_Chandelier: {
        ...
        gameruleModifications: { promotionRanks: [10,-9], promotionsAllowed: repeatPromotionsAllowedForEachColor([...defaultPromotions,typeutil.intTypes.hawks,typeutil.intTypes.guards,typeutil.intTypes.amazons]) }
    },
    Containment: {
    ...
    Knightline: {
        ...
        gameruleModifications: { promotionsAllowed: repeatPromotionsAllowedForEachColor([typeutil.intTypes.knights,typeutil.intTypes.queens]) }
    },
    Knighted_Chess: {
        positionString: {
        ...
        gameruleModifications: { promotionsAllowed: repeatPromotionsAllowedForEachColor([typeutil.intTypes.chancellors,typeutil.intTypes.knightriders,typeutil.intTypes.archbishops,typeutil.intTypes.amazons]) }
    },
    Omega: {
...
function getPromotionsAllowed(position, promotionRanks) {
    ...
    unallowedPromotes.push(typeutil.intTypes.pawns); // ['kings', 'royalQueens', 'royalCentaurs', 'pawns']
    ...
    for (const key in position) {
        ...
        if (typeutil.getPieceColorFromType(thisPieceType) === "neutral") continue; // Skip
        const trimmedType = typeutil.trimColorExtensionFromType(thisPieceType); // Slices off W/B at the end
