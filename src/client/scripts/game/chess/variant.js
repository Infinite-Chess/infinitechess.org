...
const variant = (function() {
    ...
    function getStartingPositionOfVariant({ Variant, Date }) {
        ...
        switch (Variant) {
            ...
            case "Standarch":
                ...
                return getStartSnapshotPosition({ positionString });
            case "4 Player Classic":
                positionString = '4p!P1,-1+|P2,-1+|P3,-1+|P4,-1+|P5,-1+|P6,-1+|P7,-1+|P8,-1+|p1,10+|p2,10+|p3,10+|p4,10+|p5,10+|p6,10+|p7,10+|p8,10+|R1,-2+|R8,-2+|r1,11+|r8,11+|N2,-2|N7,-2|n2,11|n7,11|B3,-2|B6,-2|b3,11|b6,11|Q4,-2|q4,11|K5,-2+|k5,11+|gk-2,5+|bk11,4+|gp-1,1|gp-1,2|gp-1,3|gp-1,4|gp-1,5|gp-1,6|gp-1,7|gp-1,8|bp10,1|bp10,2|bp10,3|bp10,4|bp10,5|bp10,6|bp10,7|bp10,8|gr-2,1|gr-2,8|br11,1|br11,8|gn-2,2|gn-2,7|bn11,7|bn11,2|gb-2,3|gb-2,6|bb11,6|bb11,3|gq-2,4|bq11,5';
                return getStartSnapshotPosition({ positionString });
            case "Space Classic":
    ...
    function getGameRulesOfVariant({ Variant, Date = math.getUTCDateTime() }, position) {
        ...
        switch (Variant) {
            ...
            case "4 Player Classic":
                ...
                gameRules.winConditions = {white: ['checkmate'], black: ['checkmate'], green: ['checkmate'], blue: ['checkmate']};
                return gameRules;
            case "Space Classic":
    ...
    /**
     * Inits the gamefile for Core. Sets the startSnapshot and gameRules properties.
     * @param {gamefile} gamefile - The gamefile
     * @param {Object} metadata - The metadata of the variant, with the following properties:
     * @param {string} metadata.Variant - Required. The name of the variant.
     * @param {number} [metadata.Date] - Optional. The version of the variant to initialize its starting position. If not specified, returns latest version.
    ...
    /**
     * Inits the gamefile for Space Classic according to the specified version. Sets the startSnapshot and gameRules properties.
     * @param {gamefile} gamefile - The gamefile
     * @param {Object} metadata - The metadata of the variant, with the following properties:
     * @param {string} metadata.Variant - Required. The name of the variant.
     * @param {number} [metadata.Date] - Optional. The version of the variant to initialize its starting position. If not specified, returns latest version.
    ...
    function initSpaceClassic(gamefile, { Variant, Date }) {
        ...
        const { position, positionString, specialRights } = getStartingPositionOfVariant({ Variant: 'Space Classic', Date })
        gamefile.startSnapshot = {
            position,
            positionString,
            specialRights,
    ...
    /**
     * Inits the gamefile for Coaip. Sets the startSnapshot and gameRules properties.
     * @param {gamefile} gamefile - The gamefile
     * @param {Object} metadata - The metadata of the variant, with the following properties:
     * @param {string} metadata.Variant - Required. The name of the variant.
     * @param {number} [metadata.Date] - Optional. The version of the variant to initialize its starting position. If not specified, returns latest version.
    ...
    /**
     * Inits the gamefile for Pawn Horde. Sets the startSnapshot and gameRules properties.
     * @param {gamefile} gamefile - The gamefile
     * @param {Object} metadata - The metadata of the variant, with the following properties:
     * @param {string} metadata.Variant - Required. The name of the variant.
     * @param {number} [metadata.Date] - Optional. The version of the variant to initialize its starting position. If not specified, returns latest version.
    ...
    function initPawnHorde(gamefile, { Variant, Date }) {
        const { position, positionString, specialRights } = getStartingPositionOfVariant({ Variant: 'Pawn Horde' })
        gamefile.startSnapshot = {
            position,
            positionString,
            specialRights,
    ...
    /**
     * Inits the gamefile for Space. Sets the startSnapshot and gameRules properties.
     * @param {gamefile} gamefile - The gamefile
     * @param {Object} metadata - The metadata of the variant, with the following properties:
     * @param {string} metadata.Variant - Required. The name of the variant.
     * @param {number} [metadata.Date] - Optional. The version of the variant to initialize its starting position. If not specified, returns latest version.
    ...
    /**
     * Inits the gamefile for Obstocean. Sets the startSnapshot and gameRules properties.
     * @param {gamefile} gamefile - The gamefile
     * @param {Object} metadata - The metadata of the variant, with the following properties:
     * @param {string} metadata.Variant - Required. The name of the variant.
     * @param {number} [metadata.Date] - Optional. The version of the variant to initialize its starting position. If not specified, returns latest version.
    ...
    /**
     * Inits the gamefile for Abundance. Sets the startSnapshot and gameRules properties.
     * @param {gamefile} gamefile - The gamefile
     * @param {Object} metadata - The metadata of the variant, with the following properties:
     * @param {string} metadata.Variant - Required. The name of the variant.
     * @param {number} [metadata.Date] - Optional. The version of the variant to initialize its starting position. If not specified, returns latest version.
    ...
    /**
     * Inits the gamefile for Amazon Chandelier. Sets the startSnapshot and gameRules properties.
     * @param {gamefile} gamefile - The gamefile
     * @param {Object} metadata - The metadata of the variant, with the following properties:
     * @param {string} metadata.Variant - Required. The name of the variant.
     * @param {number} [metadata.Date] - Optional. The version of the variant to initialize its starting position. If not specified, returns latest version.
    ...
    function initAmazonChandelier(gamefile, { Variant, Date }) {
        const { position, positionString, specialRights } = getStartingPositionOfVariant({ Variant: 'Amazon Chandelier' })
        gamefile.startSnapshot = {
            position,
            positionString,
            specialRights,
    ...
    /**
     * Inits the gamefile for Containment. Sets the startSnapshot and gameRules properties.
     * @param {gamefile} gamefile - The gamefile
     * @param {Object} metadata - The metadata of the variant, with the following properties:
     * @param {string} metadata.Variant - Required. The name of the variant.
     * @param {number} [metadata.Date] - Optional. The version of the variant to initialize its starting position. If not specified, returns latest version.
    ...
    /**
     * Inits the gamefile for Chess. Sets the startSnapshot and gameRules properties.
     * @param {gamefile} gamefile - The gamefile
     * @param {Object} metadata - The metadata of the variant, with the following properties:
     * @param {string} metadata.Variant - Required. The name of the variant.
     * @param {number} [metadata.Date] - Optional. The version of the variant to initialize its starting position. If not specified, returns latest version.
