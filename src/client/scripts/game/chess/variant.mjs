// Import Start
import { specialundo } from './specialundo.mjs'
import { legalmoves } from './legalmoves.mjs'
import { formatconverter } from './formatconverter.mjs'
import { specialdetect } from './specialdetect.mjs'
import { specialmove } from './specialmove.mjs'
import { variantomega } from './variantomega.mjs'
import { movesets } from './movesets.mjs'
    ...
    function initStartSnapshotAndGamerules(gamefile, { Variant, UTCDate, UTCTime }) {
        switch (Variant) {
            ...
            case "Omega": // Joel & Cory's version
                variantomega.initOmega(gamefile, { Variant, UTCDate, UTCTime });
                break;
            case "Omega_Squared":
                variantomega.initOmegaSquared(gamefile, { Variant, UTCDate, UTCTime });
                break;
            case "Omega_Cubed":
                variantomega.initOmegaCubed(gamefile, { Variant, UTCDate, UTCTime });
                break;
            case "Omega_Fourth":
                variantomega.initOmegaFourth(gamefile, { Variant, UTCDate, UTCTime });
                break;
                // Removed...
            /*
