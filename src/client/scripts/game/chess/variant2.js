    ...
    const variantDictionary = {
        ...
        Space_Classic: {
            ...
            gameruleModifications: {
                1709017200000: undefined, // Use standard [8,1] promotion lines (no modifications needed)
                0: { promotionRanks: [4,-3] }
            }
        },
        CoaIP: {
        ...
        Pawn_Horde: {
            ...
            gameruleModifications: { winConditions: { white: ['checkmate'], black: ['allpiecescaptured'] }, promotionRanks: [2,-7] }
        },
        Space: {
            ...
            gameruleModifications: { promotionRanks: [4,-3] }
        },
        Obstocean: {
        ...
        Abundance: {
            ...
            gameruleModifications: { promotionRanks: [6,-6] }
        },
        Amazon_Chandelier: {
            ...
            gameruleModifications: { promotionRanks: [10,-9] }
        },
        Containment: {
        ...
        Classical_Limit_7: {
            positionString: positionStringOfClassical,
            gameruleModifications: { slideLimit: 7 }
        },
        CoaIP_Limit_7: {
            positionString: positionStringOfCoaIP,
            gameruleModifications: { slideLimit: 7 }
        ...
        Classical_KOTH: {
            positionString: positionStringOfClassical,
            gameruleModifications: { winConditions: getWinConditionsOfKOTH() }
        },
        CoaIP_KOTH: {
            positionString: positionStringOfCoaIP,
            gameruleModifications: { winConditions: getWinConditionsOfKOTH() }
