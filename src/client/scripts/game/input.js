...
const input = (function(){
    ...
    let mouseHelds = [] // Mouse buttons that are currently being held.
    let keyDowns = [] // Keyboard keys that were pressed this frame.
    let keyHelds = [] // Keyboard keys that are currently being held.
    let mouseWheel = 0 // Amount scroll-wheel scrolled this frame.

    let mouseClicked = false // Was there a simulated mouse click?
    let mouseClickedDelaySeconds = 0.4 // Default: 0.12   Time the mouse must be lifted within to simulate a mouse click
    ...
    let pixelDistToCancelClick = 10 // Default: 12   If the mouse moves more than this while down, don't simulate a click
