...
const variantDictionary: { [variantName: string]: Variant } = {
	...
	Space: {
		...
		gameruleModifications: { promotionRanks: [4,-3], promotionsAllowed: repeatPromotionsAllowedForEachColor([...defaultPromotions,'hawks','centaurs','archbishops','chancellors']) }
	},
	Obstocean: {
	...
	Huygens_Test: {
		positionString: 'P1,2+|P2,2+|P3,2+|P4,2+|P5,2+|P6,2+|P7,2+|P8,2+|p1,7+|p2,7+|p3,7+|p4,7+|p5,7+|p6,7+|p7,7+|p8,7+|HU1,1+|HU8,1+|hu1,8+|hu8,8+|N2,1|N7,1|n2,8|n7,8|B3,1|B6,1|b3,8|b6,8|Q4,1|q4,8|K5,1+|k5,8+',
		gameruleModifications: { promotionsAllowed: defaultPromotionsAllowed }
	},
	'5D_Chess': {
		generator: {
