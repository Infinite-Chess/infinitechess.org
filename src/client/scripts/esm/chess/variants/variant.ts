...
const variantDictionary: { [variantName: string]: Variant } = {
	...
	'4x4x4x4_Chess': {
		generator: {
			algorithm: () => { return fourdimensionalgenerator.gen4DPosition(4, 4, 5, {
				...
				"1,1": "P1,1+|P2,1+|P3,1+|P4,1+",
				"2,1": "P1,1+|P2,1+|P3,1+|P4,1+",
				"3,1": "P1,1+|P2,1+|P3,1+|P4,1+",
				"0,2": "p1,4+|p2,4+|p3,4+|p4,4+",
				"1,2": "p1,4+|p2,4+|p3,4+|p4,4+",
		...
		movesetGenerator: () => { return fourdimensionalgenerator.gen4DMoveset(4, 4, 5, false, true); },
	...
	'8x8x8x8_Chess': {
		...
		movesetGenerator: () => { return fourdimensionalgenerator.gen4DMoveset(8, 8, 9, true, false); },
