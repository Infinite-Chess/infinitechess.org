...
// const example_position = 'b-140,-30|K-120,120|q5,0|R-60,90|r-30,90'; // Same as below but mirrored across both axes
// const example_position = 'b-140,-30|K0,0|q-120,125|R-30,60|r-30,90'; // Same as below but with an extra bishop
// const example_position = 'K0,0|q-110,125|R-30,60|r-30,90';
...
// const example_position = 'q-125,120|R-30,115|k0,0'; // Same as below, but rook same y axis as queen
// const example_position = 'R-30,60|q-125,120|k0,0'; // Rotated piece order of below
// const example_position = 'q-125,120|R-30,60|k0,0';
// const example_position = 'n5,60|q-20,60|r33,40|K40,0';
