...
/** The gamefile the navigation UI was opened for. @type {gamefile} */
let activeGamefile;
...
function onToggleNavigationBar(gamefile) {
 ...
 */
function open(gamefile, { allowEditCoords = true } = {}) {
...
function callback_Recenter(event) {
	const boundingBox = activeGamefile.startSnapshot.box;
