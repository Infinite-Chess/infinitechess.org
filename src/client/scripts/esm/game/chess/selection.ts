...
function initSelectedPieceInfo(gamefile: GameFile, mesh: Mesh | undefined, piece: Piece): void {
	// Initiate
	pieceSelected = piece;
...
function makePromotionMove(gamefile: GameFile, mesh: Mesh | undefined): void {
