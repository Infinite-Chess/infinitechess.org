 ...
 */
function makeMove(gamefile: FullGame, mesh: Mesh | undefined, moveDraft: MoveDraft, { doGameOverChecks = true, isPremove = false } = {}): Move {
	...
	if (!onlinegame.areInOnlineGame() && !gamefile.basegame.untimed && !isPremove) {
