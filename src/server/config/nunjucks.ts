...
export function configureNunjucks(app: Application): void {
	...
	// Escapes <, >, & and ' to their Unicode escapes so the output is safe
	// in any HTML context, including inline <script> blocks.
	nunjucksEnv.addFilter('tojson', (value: unknown): string => {
