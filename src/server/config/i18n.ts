...
function initTranslations(): void {
	// Load legacy monolithic TOML translations (used by i18next for old server routes)
	...
	// Load component translations used by the new SSR middleware + Nunjucks templates
