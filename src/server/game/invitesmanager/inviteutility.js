 ...
 * @property {import('../../../client/scripts/esm/util/usernamecontainer.js').UsernameContainer} usernamecontainer - The display name of the owner, "(Guest)" if not logged in, and their display elo.
