...
import { formatconverter1 } from './formatconverter1.mjs'
import { variantomega1 } from './variantomega1.mjs'
import { math1 } from './math1.mjs'
import { pieces1 } from './pieces1.mjs'
...
const variant1 = (function() {
    ...
    function initExistingTypes(gamefile) {
        ...
        for (const tpiece of teamtypes) {
            rawtypes.add(math1.trimWorBFromType(tpiece)); // Make a set with the team color trimmed
        }
