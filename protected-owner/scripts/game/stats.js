...
const stats = {
    ...
    setTextContentOfMoves() {
        ...
        stats.elementStatusMoves.textContent = `Move: ${currentPly}/${totalPlyCount}`;
    },
    ...
    updatePiecesMesh(percent) {
        ...
        stats.elementStatusPiecesMesh.textContent = `Constructing mesh ${percentString}`;
    },
    ...
    updateRotateMesh(percent) {
        const percentString = math.decimalToPercent(percent);
        stats.elementStatusRotateMesh.textContent = `Rotating mesh ${percentString}`;
    },
